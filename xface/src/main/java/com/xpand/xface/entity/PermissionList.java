...
public class PermissionList implements Serializable {
	...
	private Set<RoleDetailInfo> roleDetailInfo;
	...
	@JsonIgnore
	public Set<RoleDetailInfo> getRoleDetailInfo() {
		return roleDetailInfo;
	}

	public void setRoleDetailInfo(Set<RoleDetailInfo> roleDetailInfo) {
		this.roleDetailInfo = roleDetailInfo;
	}
