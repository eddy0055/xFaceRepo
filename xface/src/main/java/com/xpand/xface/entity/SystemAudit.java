...
public class SystemAudit implements Serializable {
	...
	public static final String MOD_BUILDING = "building";
	public static final String MOD_FLOOR = "floor";
	...
	public static final String MOD_PERSON_CERTIFICATION = "PersonCertification";
